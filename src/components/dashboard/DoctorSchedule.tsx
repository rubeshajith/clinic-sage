    ...
    <div className={styles.card}>
      ...
      <div className={styles.statsRow}>
        <div
          ...
          onClick={() => navigate("/doctors?status=active")}
        >
        ...
        <div
          className={styles.statItem}
          onClick={() => navigate("/doctors?status=inactive")}
        >
        ...
        <div
          className={styles.statItem}
          onClick={() => navigate("/doctors?status=leave")}
        >
      ...
      <div className={styles.list}>
        {doctors.map((doc) => (
          ...
          >
            ...
            <span
              className={`${styles.statusBadge} ${styles[`status${doc.status}`]}`}
            >
