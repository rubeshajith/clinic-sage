...
import { LayoutDashboard, Users, BarChart3, Bell, LogOut, Activity } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const unread = useAppSelector(s => s.notifications.notifications.filter(n => !n.read).length);
